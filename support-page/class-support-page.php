...
if( !class_exists('WBELPSSupportPage') ){
	...
	class WBELPSSupportPage{
		...
		{                                 
		   if( $hook == 'media-carousel-slider-for-elementor_page_wb-page-wbelps-support' ){	   	
					...
					<div id="tabs" class="main-container">
						<div class="tab-header">
							<div class="container-wrapper">
								<div class="logo-left">
									<a href="https://www.web-lodge.com" target="_blank" title="Web Lodge">
									...
									<div class="feature-plugin-right">
										...
										<div class="bottom-feature-plugin">
											<div class="feature feature-plugin-01">
												...
												<h3>
													<a href="https://web-lodge.com/product/shopify-to-woocommerce-migration/" target="_blank">
											...
											<div class="feature feature-plugin-01">
												...
												<h3>
													<a href="https://web-lodge.com/product/before-after-slider-for-elementor/" target="_blank">
											...
											<div class="feature feature-plugin-02">
												...
												<h3>
													<a href="https://web-lodge.com/product/news-ticker-for-elementor/" target="_blank">
											...
											<div class="feature feature-plugin-03">
												...
												<h3>
													<a href="https://web-lodge.com/product/before-after-slider-for-visual-composer/" target="_blank">
											...
											<div class="button-plugin">
												<a href="https://web-lodge.com/product-category/plugin/" class="feature-button button-blue" target="_blank">See All Plugins</a>
											</div>
										</div>
									</div>
									<div class="clear"></div>
							...
							<div id="tab-three" class="tab-content-main">
								<div class="container-wrapper">
									<div class="button-plugin service-button-quote">
										<a href="https://web-lodge.com/#contact" class="feature-button button-blue" target="_blank">
											Request a Quote
										</a>
									</div>
									<div class="clear"></div>
											...
											<div class="bottom-row-x18">
												<div class="single-item-x18">					
													...
													<div class="content-box-x18 service-heading">
														<a href="https://www.web-lodge.com/services/" target="_blank">
...
if( is_admin() )
{
	$instance->plugin_menu_slug = "wbel-media-carousel"; //Edit Value
	$instance->plugin_name = "Media Carousel Slider for Elementor"; //Edit Value
